...
namespace nmos
{
    namespace experimental
    {
        ...
        nmos::server make_node_server(nmos::node_model& node_model, nmos::experimental::node_implementation node_implementation, nmos::experimental::log_model& log_model, slog::base_gate& gate)
        {
            ...
            node_server.api_routers[{ {}, nmos::fields::sinkmetadataprocessing_port(node_model.settings) }].mount({}, nmos::experimental::make_sinkmetadataprocessing_api(node_model, node_implementation.media_profiles_patch_handler, node_implementation.media_profiles_delete_handler, node_implementation.constraints_validator, gate));
