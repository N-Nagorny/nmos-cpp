...
namespace nmos
{
    ...
    namespace bcp00401_schemas
    {
        web::uri make_schema_uri(const utility::string_t& tag, const utility::string_t& ref = {})
        {
            return{ _XPLATSTR("https://github.com/AMWA-TV/nmos-receiver-capabilities/raw/") + tag + _XPLATSTR("/APIs/schemas/") + ref };
        }

        // See https://github.com/AMWA-TV/nmos-receiver-capabilities/tree/v1.0.x/APIs/schemas/
        namespace v1_0
        {
