...
namespace nmos
{
    ...
    namespace experimental
    {
        ...
        struct node_implementation
        {
            ...
            node_implementation& on_validate_media_profiles_put(details::sinkmetadataprocessing_constraints_validator constraints_validator) { this->constraints_validator = std::move(constraints_validator); return *this; }
            ...
            nmos::experimental::details::sinkmetadataprocessing_constraints_validator constraints_validator;
        };
